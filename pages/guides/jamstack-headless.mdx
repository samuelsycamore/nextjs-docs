...
It's also worth noting that I've mostly been describing cloud-hosted services here. Some headless CMS options like Ghost and [Strapi](https://strapi.io/) are self-hosted, meaning you still have your decoupled layers, but they all live together on your server. This may be preferable for some applications.
...
(My stack of choice? Next.js, styled with Tailwind, plugged into Ghost CMS on Heroku with their one-click installation. Your mileage may vary, but this setup works great for me, and it's a breeze to set up!)
