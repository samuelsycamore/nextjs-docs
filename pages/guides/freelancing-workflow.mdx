...
<NextSeo
      ...
      description="How I successfully pitched my services and closed deals when I was getting started as a freelance web developer."
      canonical="https://www.samuelsycamore.com/guides/freelancing-workflow"
      openGraph={{
        url: 'https://www.samuelsycamore.com/guides/freelancing-workflow',
        title: 'My freelancing workflow, from cold leads to paid invoices',
        description: 'How I successfully pitched my services and closed deals when I was getting started as a freelance web developer.',
        images: [
          {
            url: 'https://samuelsycamore.com/og/freelancing-workflow.png',
            width: 1200,
            height: 630,
            alt: 'Freelancing workflow',
          },
        ],
...
![My home office in the woods](/og/freelancing-workflow.png)
...
My freelancing pal [Nat Miletic](https://www.cliowebsites.com) pointed this out, and I really believe it has been crucial to my early wins: 
