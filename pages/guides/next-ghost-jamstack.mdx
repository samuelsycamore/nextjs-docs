...
<NextSeo
      title="Build a Jamstack Blog with Next.js, Ghost CMS, Vercel & Heroku"
      description="Step-by-step walkthrough for assembling and deploying a fully functional decoupled blog."
      ...
      openGraph={{
        ...
        images: [
          {
            url: 'https://github.com/samuelsycamore/nextjs-docs/blob/master/public/og/next-ghost-jamstack-og-image.jpg',
            width: 1200,
            height: 630,
            alt: 'Og Image Alt',
          },
